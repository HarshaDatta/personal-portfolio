...
import tradingbot from "@/public/TBot.png";
...
export const projectsData = [
  {
    ...
    demo: "https://youtu.be/M4RrL8H3vZw",
    tags: ["React", "SocketIO", "HTML5 Canvas", "RoughJS", "CSS"],
    imageUrl: whiteboard,
  },
  {
    title: "Binace Trading Bot",
    description:
      "Created a Python-based Binance trading bot for automated trading, designed to execute trades based on predefined strategies and market conditions.",
    demo: "https://youtu.be/aWx-NB676Zg",
    tags: ["Python", "BinanceAPI", "Tkinter"],
    imageUrl: tradingbot,
  },
  {
    ...
    demo: "https://youtu.be/s-IWHQC_I_I",
